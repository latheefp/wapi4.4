...
<head>
  ...
  <?php $title=Configure::read('app.name'). " " .Configure::read('app.version'); ?>
  <title><?= $title ?></title>
 ...
 <link rel="stylesheet" href="/css/mahallu.css">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark"><?= $this->fetch('title') ?></h3>
          </div> 
          <div class="col-sm-6">
...
<!-- //DataTables-->
 ...
 <script src="/plugins/DataTableEditor/plugin/editor.select2.js"></script>
