...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form  id="costcalculation-form-current" action="/submit-form" method="post" >
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" id="1select-message-type" name="message_type" onchange="submitFormcurrent()">
                            <option value="user_Initiated_rate">User Initiated</option>
                            <option value="business_Initiated_rate">Business-initiated</option>
                        </select>
                    </div>
...
//<script>
    ...
    function submitFormcurrent() {
        ...
        var form = $("#costcalculation-form-current")
        var url = '/ajaxes/getrate';
        $.ajax({
            beforeSend: function (xhr) { // Add this line
                xhr.setRequestHeader('X-CSRF-Token', csrfToken);
